...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MIDITimeTableView/MIDITimeTableView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/StepProgressBar/StepProgressBar.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftyJSON/SwiftyJSON.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TCProgressBar/TCProgressBar.framework"
